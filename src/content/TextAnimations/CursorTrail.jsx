...
const CursorTrail = ({
  ...
  const handleMouseMove = e => {
    ...
    setTrail(prev => {
      ...
      // randomFloat off হলে সব particle একই (mid) size, on হলে random size
