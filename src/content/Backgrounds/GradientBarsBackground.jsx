...
const GradientBars = ({
  ...
  // above 0.5 we stack a second, larger-grain layer on top so the effect keeps
  // growing instead of plateauing once a single layer's opacity maxes out
          ...
          {Array.from({ length: numBars }).map((_, index) => {
            ...
            return (
              ...
              >
                ...
                {showSecondLayer && (
                  <div
                    style={noiseLayerStyle((noiseAmount - 0.5) * 2, 220, "0.15s")}
                  />
                )}
              </div>
            )
