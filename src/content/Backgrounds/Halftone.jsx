...
void main() {
  ...
  // rotate uv for angled direction
  ...
  if (uDir < 1.5) {
    ...
    // angled (custom angle via uAngle)
...
const Halftone = ({
  ...
  // Animation
  speed = 0.7,
  direction = 'angled',  // 'diagonal'|'horizontal'|'vertical'|'radial'|'angled'|'spiral'|'checker'|'ripple'
  angle = 45,              // degrees — used when direction='angled'
  // Shape & Size
  scale = 1.0,
  dotSize = 0.5,           // 0.1–1.0
  shape = 'circle',        // 'circle'|'square'|'diamond'|'triangle'|'star'|'cross'|'ring'|'hexagon'
  // Wave
  waveFreq = 1.0,
  opacity = 1.0,
  className = '',
