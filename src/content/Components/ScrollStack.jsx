...
function ScrollStack(props) {
  ...
  // shrink spacing/stacking + image size on smaller screens
  ...
  const imgSize = bp === 'mobile' ? 0 : bp === 'tablet' ? 150 : 210; // 0 = image hidden on mobile
          ...
          >
            <div className="flex gap-4 sm:gap-5 md:gap-7 items-stretch">
              ...
              <div className="flex-1 flex flex-col min-w-0 py-1">
                <div style={{ fontSize: dateSize }} className="text-gray-400">
                  {card.date}
                </div>
                {card.title && (
