...
export const PROPS_DATA = [
  ...
  { name: 'colors',          type: 'string[]', def: '["#40ffaa","#40aaff","#ff40aa","#aa40ff"]', desc: 'Palette randomly assigned to each particle.' },
  // SIZING
  ...
  // MOUSE INTERACTION
  { name: 'mouseControls',   type: 'object',   def: '{ enabled: true, radius: 150, strength: 5 }', desc: 'Pointer repulsion settings: enabled, radius (px), strength (force multiplier).' },
  // PHYSICS
