...
export const getShadcnCmds = (variant) => ({
  pnpm: `pnpm dlx shadcn@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
  npm:  `npx shadcn@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
  yarn: `yarn shadcn@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
  bun:  `bunx shadcn@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
});
export const getJsrepoCmds = (variant) => ({
  pnpm: `pnpm dlx jsrepo@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
  npm:  `npx jsrepo@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
  yarn: `yarn jsrepo@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
  bun:  `bunx jsrepo@latest add ${DOMAIN_URL}/r/MagneticText-${variant}`,
});
