...
const MouseRepelGrid = ({
  ...
  useEffect(() => {
    ...
    const S = {
      ...
      t0:performance.now(), rafId:null,
      lineMesh:null, vignetteMesh:null, cx:0, cy:0,
    };
    ...
    const onClick  = (e) => { if(!pulseOnClick)return; const r=wrap.getBoundingClientRect(); S.pulseCenter.x=e.clientX-r.left; S.pulseCenter.y=e.clientY-r.top; S.pulseStart=(performance.now()-S.t0)/1000; };
