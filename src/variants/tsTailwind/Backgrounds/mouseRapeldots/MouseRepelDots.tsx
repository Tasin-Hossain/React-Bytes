...
const MouseRepelDots = memo(
  ({
    ...
    useEffect(() => {
      if (prevLayoutRef.current.dotRadius !== dotRadius || prevLayoutRef.current.dotSpacing !== dotSpacing) {
      ...
      function draw() {
        ...
        dots.forEach(d => {
          ...
          let color: string | CanvasGradient =
            gradFill ?? (energy > 0.6 ? dotColorHot : energy > 0.25 ? dotColorMid : dotColor);
