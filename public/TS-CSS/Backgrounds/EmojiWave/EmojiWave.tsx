...
function buildCharAtlas(characters: string, color: string, invert: boolean): CharAtlas {
...
export default function EmojiWave({
  ...
  const style = {
    wrapper: { position: "relative" as const, width: "100%", height: "100%", overflow: "hidden" },
    canvas: {
