...
function useResponsiveFontSize(containerRef: React.RefObject<HTMLDivElement>) {
...
/* ── MagneticCursor ──────────────────────────────────────── */
function MagneticCursor({ containerRef }: { containerRef: React.RefObject<HTMLDivElement> }) {
