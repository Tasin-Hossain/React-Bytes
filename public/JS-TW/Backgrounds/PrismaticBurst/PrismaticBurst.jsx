      ...
      <shaderMaterial
        ...
        fragmentShader={/* glsl */ `
          ...
          float noise2d(vec2 p){
              ...
              float a = randVal(i+vec2(0.0,0.0)); float b = randVal(i+vec2(1.0,0.0));
              float c = randVal(i+vec2(0.0,1.0)); float d = randVal(i+vec2(1.0,1.0));
          ...
          vec3 colorFromGradient(float v){
              ...
              return mix(uColors[idx], uColors[idx+1], frac);
          }
          ...
          void renderMain(out vec4 fragColor, in vec2 fragCoord){
              ...
              if (uAnimationType==0) {
                  float a=uTime*0.15; float ca=cos(a); float sa=sin(a);
              ...
              if (uDistort>0.0){
                  ...
                  ang+=(d-0.5)*uDistort*0.6; dist+=(d-0.5)*uDistort*0.3;
              }
...
export const PrismaticBurst = ({
  ...
  return (
    <div
      className={("flex flex-col items-center gap-4 p-0 rounded-lg w-full h-screen", className)}
